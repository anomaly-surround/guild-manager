...
`modules/points.js` (Loot & Points, ES module, optional per team; rotation or DKP mode per `team.loot_mode`), `modules/settings.js` (ES module). Shared screens: `auth`, `billing`, `teams`, `team-view`
