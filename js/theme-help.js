...
function showHelpModal() {
    const sections = [
        ...
        { icon: '&#128142;', title: 'Loot & Points', text: 'Optional module, off by default: turn it on in Settings. Log who received which drop and keep a points balance per member for fair distribution. Premium adds wishlists, auctions and automatic point decay.' },
