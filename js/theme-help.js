...
function showHelpModal() {
    const sections = [
        ...
        { icon: '&#128274;', title: 'Account & data', text: 'Account menu → <b>Account &amp; data</b>. Download everything about you and the teams you lead as one JSON file, or delete your account: sign-in, memberships and personal entries go, team histories keep your past entries as "Deleted user". Teams you lead with other members must be transferred or deleted first.' },
